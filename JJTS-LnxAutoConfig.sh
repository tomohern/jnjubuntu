...
#
#               Added question for Auris Build or J&J Generic with just Centrify. Can do a lot more
#               once we have requirements for core components/packages.
#
#               Assumed build is a generic Ubuntu 18.04.4 LTS with using entire drive encrypted and
#               LVM set up. Minimal Install ONLY, no Libre Office or other apps. Will create a
#               preseed file as time permits. The preseed could also kick off this script upon 
#               completion.
##
# Permissions : Sudo, User
#
# Requires    : JJNet, Internet Access
#
...
# Begin JJT-BashScript Standard Variables
  ...
  prgBuild="0008"                                                            # update during dev
  prgRelDate="Released: 3/27/2020"                                           # changes
...
# ----------------------------------------- [doAurisBuild] -------------------------------------------
function doAurisBuild(){
  printf "This is the AURIS Build Process"
  printf "==============================="
...
# ----------------------------------------- [doJ&JBuid] -------------------------------------------
function doJJBuild(){
# This is a generic J&J Build based on Centrify
  printf "This is the J&J Dev Build Process"
  printf "================================="
...
printf "Do you wish to Build an AURIS or J&J Generic Ubuntu Linux Desktop? [a/A/j/J] "
read whichBuild
printf "\n"

case $whichBuild in
[Aa])
  printf "Performing an Auris Build...\n"
  doAurisBuild
  printf "Done!\n"
  ;;
[Jj])
  printf "Performing an J&J Generic Build...\n"
  doJJBuild
  printf "Done!\n"
  ;;
*)
  printf "Input not valid! Looking for either an 'a', 'A', 'j' or 'J' here!"
;;
esac
